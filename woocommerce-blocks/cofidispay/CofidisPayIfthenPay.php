...
final class CofidisPayIfthenPay extends AbstractPaymentMethodType {
	...
	public function get_payment_method_script_handles() {
		wp_register_script( 'wc-payment-method-cofidispay-ifthenpay', plugins_url( 'build/index.js', __FILE__ ), array(), WC_IfthenPay_Webdados()->get_version().( WP_DEBUG ? '.' . wp_rand( 0, 9999 ) : '' ), true );
		return [ 'wc-payment-method-cofidispay-ifthenpay' ];
	}
