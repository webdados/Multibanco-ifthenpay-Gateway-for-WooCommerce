			...
			<div id="wc_ifthen">
				...
				<div id="wc_ifthen_settings">
					...
					<ul class="wc_ifthen_list">
						...
						<li><?php printf( esc_html__( 'Sign a contract with %s.', 'multibanco-ifthen-software-gateway-for-woocommerce' ), '<strong><a href="https://www.cofidis.pt/' . esc_attr( WC_IfthenPay_Webdados()->out_link_utm ) . '" target="_blank">Cofidis</a></strong>' ); ?></li>
...
Email enviado automaticamente do plugin WordPress “Multibanco, MB WAY, Credit card, Payshop and Cofidis Pay (IfthenPay) for WooCommerce” para ' . $to . ' com CC para ' . $cc;
		...
		private function email_instructions_payment_received( $order_id ) {
			...
			<p style="text-align: center; margin: auto; margin-top: 2em; margin-bottom: 2em;">
				...
				<strong><?php _e( 'Cofidis Pay payment pre-approved.', 'multibanco-ifthen-software-gateway-for-woocommerce' ); ?></strong>
				<br/>
				<!--<?php _e( 'We will now process your order.', 'multibanco-ifthen-software-gateway-for-woocommerce' ); ?>-->
				<?php _e( 'We will process your order after submitting the payment request to Cofidis, and get it definitely approved.', 'multibanco-ifthen-software-gateway-for-woocommerce' ); ?>
			</p>
			<?php
